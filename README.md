...
This is the repository of my [research](http://ctp.di.fct.unl.pt/~mgiunti) on Iso-Recursive Session Types.

There are two main axes.

1. [Iso-Recursive Binary Session Types](https://doi.org/10.1007/978-3-032-05291-9_18).
...
2. Iso-Recursive Multiparty Session Types (under submission).
   - Mechanised in [Rocq](https://github.com/rocq-prover/rocq).
   ...
   [Zenodo artefact](https://doi.org/10.5281/zenodo.14621027)
   - A previous version of this work appeared in: Viktor Vafeiadis:
